...
/** 보유세(주간 실행 시 잔액에서 징수 후 중앙 금고로 적립) */
...
export function maxAmountPerTransfer(balance: number, dp: DecimalPlaces = 0): number {
  return roundToDecimalPlaces(balance * PER_TRANSFER_MAX_RATE, dp);
}
